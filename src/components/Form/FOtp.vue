    ...
    <div class="flex-y-center gap-3">
      <template v-for="(v, index) in values" :key="index">
        <input
          ...
          "
          class="w-full text-center rounded-lg outline-none transition-300 bg-gray-500 border border-transparent focus:border-blue-200 h-[46px] font-medium text-xl leading-130 overflow-hidden focus:bg-white"
          :class="inputClass"
          pattern="[0-9]"
